...
3. If macOS blocks this unsigned edition, use Finder's Open command or the
...
4. If startup fails, double-click start-local.command and keep its Terminal
   window open for diagnostics. This unsigned edition intentionally has no `.app`
...
This is an unsigned portable edition, not a signed or notarized Mac app. Native automated
